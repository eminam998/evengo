...
<section class="mb-32 pb-32 mt-64 text-gray-800">
    ...
    <div class="block rounded-lg shadow-lg py-10 md:py-12 px-4 md:px-6"
      ...
      <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-x-6 mb-12">
        <div class="mb-12 lg:mb-0 text-center mx-auto">
          ...
          <h6 class="font-medium">Bosna i Hercegovina</h6>
        </div>
        <div class="mb-12 lg:mb-0 text-center mx-auto">
          ...
          <h6 class="font-medium">Bihać, 77000</h6>
        </div>
        <div class="mb-6 md:mb-0 text-center mx-auto">
          ...
          <h6 class="font-medium">+387 222 333</h6>
        </div>
        <div class="text-center mx-auto">
          ...
          <h6 class="font-medium">Porezni broj: 273 384</h6>
        </div>
      </div>
        ...
        <form  @submit.prevent="submit" enctype="multipart/form-data">
          <div class="form-group mb-6">
            ...
            focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" 
              placeholder="Ime" id="name" name="name" v-model="form.name" >
          </div>
          <div class="form-group mb-6">
            ...
            m-0
            focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
              placeholder="Email adresa" id="email" v-model="form.email" name="email" >
          </div>
          <div class="form-group mb-6">
            <textarea class="
            form-control
